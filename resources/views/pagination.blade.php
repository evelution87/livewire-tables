<div wire:key="{{ uniqid('pagination-') }}">
    @if (1 || $paginator->hasPages())
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex items-center justify-end">
                    ...
                    <input type="text" wire:model.lazy="search"
                           class="px-2 py-2 ml-2 rounded-md shadow-sm text-sm font-medium text-gray-500 bg-white border border-gray-300"
                           placeholder="Search"
                    />

                    <select wire:model="per_page"
                            class="pl-2 pr-8 py-2 ml-2 rounded-md shadow-sm text-sm font-medium text-gray-500 bg-white border border-gray-300 focus:ring-transparent focus:border-gray-400 transition z-10">
                    ...
                    @if ($paginator->hasPages())
                        ...
                        <span>
                            ...
                            @if ($paginator->onFirstPage())
                                <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                                    <span class="relative inline-flex items-center px-2 py-2 -mr-px text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-l-md leading-5"
                                          aria-hidden="true">
                        ...
                        @if (true)
                            ...
                            <select wire:model="page"
                                    class="pl-2 pr-8 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 focus:ring-transparent focus:border-gray-400 transition z-10">
